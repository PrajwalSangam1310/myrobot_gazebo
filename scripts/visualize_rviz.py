...
if __name__=="__main__":
    ...
    grid = MarkerArray()
    grid.markers = [Marker() for i in range(14)]
    delta = 0.1524
    base = 2.1336
    dest = 0.3048
    ...
    for i in range(3):
        for j in range(3):
            ...
            grid.markers[i*3+j].pose.position.z = 0.01


            grid.markers[i*3+j].header.frame_id = 'grid'
    ...
    grid.markers[9].pose.position.z = 0
    grid.markers[9].header.frame_id = 'grid'
    ...
    induction_points = [(0,6),(0,9), (15,6), (15,9)]
    ...
    for i in range(4):
        ...
        grid.markers[10+i].pose.position.z = 0
        grid.markers[10+i].header.frame_id = 'grid'
